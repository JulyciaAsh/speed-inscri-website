    ...
    <section className="py-16 bg-gradient-to-r from-green-600 to-red-600">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-4xl font-bold text-white mb-6 font-montserrat">
          Vivez la dolce vita étudiante !
        </h2>
        <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
          Découvrez comment étudier en Italie peut enrichir votre parcours académique 
          et personnel. Consultation gratuite avec nos experts.
        </p>
