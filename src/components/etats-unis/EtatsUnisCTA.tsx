    ...
    <section className="py-16 bg-gradient-to-r from-blue-600 to-red-600">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-4xl font-bold text-white mb-6 font-montserrat">
          Réalisez le rêve américain !
        </h2>
        <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
          Accédez aux meilleures universités mondiales et construisez votre avenir 
          aux États-Unis. Nos experts vous accompagnent dans chaque étape.
        </p>
