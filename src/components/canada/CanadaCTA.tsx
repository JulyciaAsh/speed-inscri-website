    ...
    <section className="py-16 bg-gradient-to-r from-red-600 to-orange-600">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-4xl font-bold text-white mb-6 font-montserrat">
          Votre avenir vous attend au Canada !
        </h2>
        <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
          Découvrez comment étudier au Canada peut transformer votre carrière et votre vie. 
          Consultation gratuite avec nos experts en immigration étudiante.
        </p>
